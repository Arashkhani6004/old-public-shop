    ...
    <div class="container-fluid  dashboard-content">
        ...
        <div class="row w-100 m-0">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
                <a href="{{ url('adminstrator/products/') }}" class="btn btn-default btn-info" style="float: left"
            ...
            <div class="col-9">
                <div class="card">
                    <form method="post" action="{{ url('/adminstrator/properties/delete') }}" style="float: left">
                        {{ csrf_field() }}
                        <div class="px-2 py-3">
                            ...
                            <a href="{{ URL::action('Admin\PropertiesController@getAdd', $id) }}" type="button"
                                                            ...
                                                            <thead>
                                                                <tr role="row">
                                                                    <th class="sorting_asc" tabindex="0"
                                                                        ...
                                                                        <input id="check-all" style="opacity: 1;position:static;"
                                                            ...
                                                            <tbody>
                                                                @foreach ($questions as $key => $question)
                                                                    <tr role="row" class="odd">
                                                                        ...
                                                                        <td class="sorting_1">
                                                                            {{ $question->status ? 'بالایی' : 'پایینی' }}</td>
                                                                        <td>
                                                                            <a href="{{ URL::action('Admin\PropertiesController@getEdit', $question->id) }}"
                                                                                type="button" class="btn btn-space btn-warning"
            ...
            <div class="col-lg-3">
                <div id="list">
                    ...
                    <ul>
                        ...
                        @if($qu->status == 0)
                            <li class="list-unstyled  my-2 p-3 shadow-sm rounded-lg" id="arrayorder_{!! stripslashes($qu['id']) !!}"
                                style="background-color: #333">{!! stripslashes($qu['description']) !!}
                                <div class="clear"></div>
                            </li>
                        @endif
                        @endforeach
                ...
                $("#list ul").sortable({
                    ...
                    update: function() {
                        ...
                        var order = $(this).sortable("serialize") + '&update=update' +
                            '&_token=' + CSRF_TOKEN;
                        $.post("{!! URL::action('Admin\PropertiesController@postSort') !!} ", order, function(theResponse) {
