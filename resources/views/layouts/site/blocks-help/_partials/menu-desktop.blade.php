        ...
        <div class="row w-100 m-0">
            <div class="col-xl-9 col-lg-8 col-md-9 p-1 align-self-center position-relative">
                <ul class="d-flex align-items-center p-0 m-0">
                    <li class="list-unstyled">
                        <a href="/" class="logo">
                            <img src="{{asset('assets/site/images/frame-logo.png')}}" id="logo"
                                width="65" alt="..."
                                title="..." />
                        </a>
                    </li>
                    <li class="list-unstyled">
                        <a href="" class="text-dark small px-2"> صفحه اصلی </a>
                    </li>
                    <li class="list-unstyled mega-item">
                        <a href="" class="text-dark small px-2 d-flex align-items-center">
                            محصولات
                    ...
                    @if ($brandsCount > 0)
                        <li class="list-unstyled">
                            <a href="{{ route('site.help.brand.list') }}" class="text-dark small px-2"> برندها </a>
                        </li>
                    @endif
                    @if ($blogCount > 0)
                        <li class="list-unstyled">
                            <a href="{{ route('site.help.blog.cat') }}" class="text-dark small px-2"> دانستنی ها </a>
                        </li>
                    @endif
                    <li class="list-unstyled">
                        <a href="" class="text-dark small px-2"> تماس با ما </a>
                    </li>
                    <li class="list-unstyled">
                        <a href="" class="text-dark small px-2"> درباره ما </a>
                    </li>
                </ul>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-3 p-1 align-self-center">
                <ul class="d-flex align-items-center m-0 p-0 left justify-content-end">
                    ...
                    <li class="list-unstyled">
                        @if (!\Auth::check())
                            <a href="" class="gap-1 px-2 d-flex align-items-center">
