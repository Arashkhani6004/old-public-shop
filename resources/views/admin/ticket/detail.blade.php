...
<div class="container-fluid dashboard-content">
	<div class="row w-100 m-0">
		<div class="col-lg-12 mx-auto py-1 px-0">
            <a href="{{url('adminstrator/tickets/')}}" class="btn btn-default btn-info" style="float: left" data-toggle="tooltip" data-placement="top" title="" data-original-title="بازگشت">
                بازگشت
            ...
            <h3 class="bg-white py-2 px-4 rounded-lg">
                ...
                @if($start->order_item_id != null)
                 @php

          $orderitem = \App\Models\OrderItem::find($start->order_item_id);
                 @endphp
                <br>
{{ 'تیکت مرجوعی مربوط به سفارش'.' '.@$orderitem->order_id}}
                @endif
			</h3>
