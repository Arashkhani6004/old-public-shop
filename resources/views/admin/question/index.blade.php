...
<div class="container-fluid  dashboard-content">
	...
	<div class="row w-100 m-0">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
            <a href="{{url('adminstrator/products/')}}" class="btn btn-default btn-info" style="float: left" data-toggle="tooltip" data-placement="top" title="" data-original-title="بازگشت">
                بازگشت
	...
	<div class="card">
		<form method="post" action="{{url('/adminstrator/question/delete')}}" style="float: left">
			{{ csrf_field() }}
			<div class="px-2 py-3">
				...
				<a href="{{URL::action('Admin\QuestionController@getAdd' , $id)}}" type="button" class="btn btn-space btn-primary">
                    	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
