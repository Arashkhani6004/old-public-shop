...
Route::post('/login-cart/', 'Panel\LoginController@LoginCart');
Route::get('/confirm-cart/', 'Panel\LoginController@ConfirmCart');
Route::post('/register-cart/', 'Panel\LoginController@RegisterCart');




Route::post('panel/setcity', 'Panel\PanelController@setCity')->name('panel.set-city');
Route::post('panel/setcity-edit', 'Panel\PanelController@setCityEdit')->name('panel.set-city-edit');
...
Route::post('/save-password', 'PanelController@savePassword');
//==address==
...
Route::get('/order/factor/{id}', 'PanelController@getfactor')->name('panel.getfactor');
...
Route::get('/order-detail/{id}', 'PanelController@OrderDetail');
});
