...
<div class="container-fluid  dashboard-content">
    ...
    <div class="row">
		...
		<form method="post" action="{{url('/adminstrator/slider/delete')}}">
			{{ csrf_field() }}
			<div class="py-3 px-2">
				...
				<a href="{{url('adminstrator/slider/add')}}" type="button" class="btn btn-space btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
										...
										<div class="col-sm-12">
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd" @if($row->status == 1) style="background-color: cyan" @endif>
														<td class="sorting_1">
    ...
    <div class="col-lg-4">
        <div id="list">
            ...
            <ul>
                ...
                <div class="alert alert-primary alert-dismissable rounded-lg" style="direction: rtl; margin: 0px auto;">
                    <i class="fa fa-arrow-circle-down"></i>
                    <span style="font-size: 10px;">ترتیب بنر های  ابتدایی </span>
                </div>
                @foreach($categorySort5 as $rowSort5)

                    <li class="list-unstyled  my-2 p-3 shadow-sm rounded-lg" id="arrayorder_{!! stripslashes($rowSort5['id']) !!}"  style="background-color: #3b3f54" >{!! stripslashes($rowSort5['title']) !!}
                        <div class="clear"></div>
                    </li>
