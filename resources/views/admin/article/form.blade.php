...
<div class="row">
    ...
    <div class="col-lg-6 form-group">
        ...
        <select class="form-control" required id="parent_id" name="parent_id" value="@if(isset($data->parent_id)){{$data->parent_id}}@endif">
...
{{--    </div>--}}
    ...
    <div class="col-lg-3 form-group">
        ...
        <div class="col-12 col-sm-8 col-lg-6 pt-1">
            <div class="switch-button switch-button-yesno">
                <input type="checkbox" value="1" @if(isset($data->baner_type) && $data->baner_type == 1) checked="checked" @endif name="baner_type" id="baner_type">
                <span>
                    <label for="baner_type"></label>
                </span>
            </div>
        </div>
    </div>
