...
class UploadImgArticle
{
    public function uploadPic($file, $path, $resize = true)
    {
        ...
        if (in_array($extension, $ext)) {
            if (!File::isDirectory("assets/uploads/")) {
                File::makeDirectory("assets/uploads/");
            }
            if (!File::isDirectory("assets/uploads/content/")) {
                File::makeDirectory("assets/uploads/content/");
            }
...
//            $fileName = md5(microtime()) . ".$extension";
            ...
            if ($resize) {
                ...
                Resizer::resizePic($pathMain . $fileName, $pathSmall . $fileName, 150, 100, $fileExt);
                Resizer::resizePic($pathMain . $fileName, $pathMedium . $fileName, 450, 300, $fileExt);
                Resizer::resizePic($pathMain . $fileName, $pathBig . $fileName, 900, 600, $fileExt, True);
