<div class="row w-100 m-0">
    ...
    <div class="col-lg-6 form-group">
        ...
        <div class="controls">
            <input autocomplete="off" type="text" name="date" id="datepicker1" class="form-control" value="@if(isset($data->date)){{$data->date ? \App\Library\Help::persian2LatinDigit(jdate('d/m/Y', DateTime::createFromFormat('Y-m-d H:i:s', $data->date)->getTimestamp()))  : ''}}@endif" />
        </div>
    </div>
    <div class="col-lg-6 form-group">
        <label for="to_date" class="col-form-label">ساعت تایمر</label>
        <div class="controls">
