...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
{{--		<form method="post" action="{{url('/adminstrator/brands/delete')}}" style="float: left">--}}
{{--			{{ csrf_field() }}--}}
			<div class="px-2 py-3">
...
{{--					حذف انتخاب شده ها--}}
{{--				</button>--}}
				<a href="{{url('adminstrator/brands/add')}}" type="button" class="btn btn-space btn-primary">
                    	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td class="sorting_1">            {{($brands->appends(Request::except('page'))->currentPage() - 1) *
                                          ($brands->appends(Request::except('page'))->perPage()) + $key+1}}</td>
														<td class="sorting_1"><img class="mx-auto"
																src="{{asset('assets/uploads/content/brand/big/'.$brand->image)}}"
																width="70" height="70" alt="Image"></td>
														<td class="sorting_1">{{@$brand->title}}</td>
                                                        <td class="sorting_1">
                                                            {{@$brand['status'] == 1 ? 'نمایش در صفحه' : 'عدم نمایش در صفحه'}}
                                                            {{@$brand['footer'] == 1 ? '/نمایش در فوتر' : ''}}
                                                        </td>
														<td>
