...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
			...
			<div class="px-2 py-3">
				...
				<a href="{{url('adminstrator/shipment/add')}}" type="button" class="btn btn-space btn-primary">
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td class="sorting_1">{{@$ship->title}}</td>
                                                        <td class="sorting_1">
                                                            {{@$ship['status'] == 1 ? 'نمایش در صفحه' : 'عدم نمایش در صفحه'}}

                                                        </td>
														<td>
															<a href="{{URL::action('Admin\ShipMentController@getEdit',$ship->id)}}"
																type="button"
																class="btn btn-space btn-warning"
																data-toggle="tooltip" title="ویرایش">
																<i class="fa fa-edit"> </i>
															</a>
                                                            <a href="{{URL::action('Admin\ShipMentController@getDeleteShip',$ship->id)}}"
