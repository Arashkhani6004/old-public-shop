    ...
    <ul class="p-0 m-0 d-flex align-items-center gap-2">
        <li class="list-unstyled">
            <div class="form-check mb-0">
                <input class="form-check-input" type="radio" value="most" name="" v-model="sortBy" id="sort-item1"  @change="filterProducts()" v-model = "sortBy">
        ...
        <li class="list-unstyled">
            <div class="form-check mb-0">
                <input class="form-check-input" type="radio" value="cheapest" v-model="sortBy" id="sort-item2"  @change="filterProducts()" v-model = "sortBy">
        ...
        <li class="list-unstyled">
            <div class="form-check mb-0">
                <input class="form-check-input" type="radio" value="expensive" v-model="sortBy" id="sort-item3"  @change="filterProducts()" v-model = "sortBy">
