<div class="row w-100 m-0">
	...
	<div class="col-lg-6 form-group">
		...
		<div class="controls">
			<input autocomplete="off" type="text" name="from_date" id="datepicker1" class="form-control" />
		</div>
	</div>
	<div class="col-lg-6 form-group">
		<label for="to_date" class="col-form-label">تاریخ پایان اعتبار</label>
        <div class="controls">
			<input autocomplete="off" type="text" name="to_date" id="datepicker2" class="form-control" />
		</div>
	</div>
        <div class="col-lg-6 form-group">
