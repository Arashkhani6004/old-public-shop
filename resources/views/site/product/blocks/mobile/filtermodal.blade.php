...
{{--									@include('site.product.blocks.search-results')--}}
						...
						<div class="accordion-item">
							<p class="accordion-header h2" id="headingTwo{{$key}}">
								<button class="accordion-button collapsed" type="button"
									data-bs-toggle="collapse" data-bs-target="#collapseFilterxs2{{$key}}"
									aria-expanded="false" aria-controls="collapseFilterxs2{{$key}}">
									{{$row->title}}
								</button>
							</p>
							<div id="collapseFilterxs2{{$key}}" class="accordion-collapse collapse"
								aria-labelledby="headingTwo{{$key}}" data-bs-parent="#accordionFilterxs">
								<div class="accordion-body">
							...
							<div id="collapseFilterxs3" class="accordion-collapse collapse"
								...
								<div class="accordion-body">
									<div class="d-md-none d-sm-block d-xs-block">
										@include('site.product.blocks.mobile.price-filter-mobile')
									</div>
								</div>
							</div>
						</div>
