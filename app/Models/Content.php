...
class Content extends Model
{
    ...
    protected $fillable = [
        ...
        'parent_id', 'description_seo', 'url', 'title_seo','baner_type','link'
    ...
    {
        $records = $query->wherein('content_type',[3,6,7,8]);
        return $records;
    ...
    public function scopeBaner4($query)
    {
    ...
    {
        $records = $query->whereContentType('12');
        return $records;

    }
    public function scopeMobile($query)
    {
        $records = $query->wherein('content_type',[9,10,11,12]);
        return $records;
    ...
    {
        return $this->hasMany('App\Models\Content','parent_id')->with('childs')->sortby('sort','ASC');
    }
    public function cat()
    {
