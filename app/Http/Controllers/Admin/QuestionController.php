...
class QuestionController extends Controller
{
    ...
    public function postAdd(Request $request)
    {
        ...
        if ($input['product_id'] != null) {
            return Redirect::action('Admin\QuestionController@get', $input['product_id'])->with('success', 'کدهای مورد نظر با موفقیت اضافه شدند.');
                ...
                return \redirect('/adminstrator/questions/')->with('success','آیتم موردنظر با موفقیت ثبت شد.');
            }
        }
    ...
    public function postEdit($id, Request $request)
    {
        ...
        return \redirect('/adminstrator/question/'.$question->product_id)->with('success','آیتم موردنظر با موفقیت ثبت شد.');
        }
        else{
            return \redirect('/adminstrator/questions/')->with('success','آیتم موردنظر با موفقیت ثبت شد.');
        }
