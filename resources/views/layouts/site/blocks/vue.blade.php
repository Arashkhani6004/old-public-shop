    ...
    new Vue({
        ...
        methods: {
            ...
            plusQnty(cartItemId) {
                ...
                if (item) item.productQuantity = Number(item.productQuantity) + 1;
            },
            ...
            minusQnty(cartItemId) {
                ...
                if (item) {
                    ...
                    if (quantity > 1) item.productQuantity = quantity - 1;
                }
            },
                ...
                axios.post(`{{ route('product.variable') }}`, {
                    ...
                    .then(response => {
                        ...
                        if (response.data.image != null) {
                            const btnChange = document.getElementById("pills-" + id);
            ...
            getShopingMethod: async function() {
                ...
                const response = await axios.get('{{ url('/getShoping/') }}?addres_id=' + this
                    .defaultAddress);
                console.log(response.data.shippingmethods.length)
