...
//            $fileName = md5(microtime()) . ".$extension";
            ...
            if ($resize) {
                ...
                Resizer::resizePic($pathMain . $fileName, $pathSmall . $fileName, 255, 70, $fileExt);
                Resizer::resizePic($pathMain . $fileName, $pathMedium . $fileName, 255, 70, $fileExt);
                Resizer::resizePic($pathMain . $fileName, $pathBig . $fileName, 255, 70, $fileExt, True);
