    ...
    <div class="container-fluid  dashboard-content">
        ...
        <div class="row">
            <div class="card col-lg-8">
                <form method="post" action="{{url('/adminstrator/mobile-slider/delete')}}">
                    {{ csrf_field() }}
                    <div class="py-3 px-2">
                        ...
                        <a href="{{url('adminstrator/mobile-slider/add')}}" type="button" class="btn btn-space btn-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                    ...
                                                    <table class="table table-striped table-bordered first dataTable"
                                                        ...
                                                        @foreach($slider as $key=> $row)
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td class="sorting_1">@if($row->content_type == 9)
                                                                        اسلایدر اصلی موبایل
                                                                    @elseif($row->content_type == 10)
                                                                        اسلایدر اول موبایل
                                                                    @elseif($row->content_type == 11)
                                                                        اسلایدر دوم موبایل
                                                                    @endif
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a href="{{URL::action('Admin\SliderController@getEditMobile',$row->id)}}"
                                                                       type="button"
                ...
                <div id="list">
                    ...
                    <ul>
                        ...
                        <div class="alert alert-primary alert-dismissable rounded-lg" style="direction: rtl; margin: 0px auto;">
                            ...
                            <span style="font-size: 10px;">	ترتیب بنرهای اول موبایل  </span>
                        </div>
                        @foreach($categorySort5 as $rowSort)
                        ...
                        <div class="alert alert-primary alert-dismissable rounded-lg" style="direction: rtl; margin: 0px auto;">
                            <i class="fa fa-arrow-circle-down"></i>
                            <span style="font-size: 10px;">ترتیب بنر های  دوم موبایل </span>
                        </div>
                        @foreach($categorySort6 as $rowSort4)
