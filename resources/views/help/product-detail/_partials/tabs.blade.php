<div class="tabs mt-5">
    ...
    <div class="container">
        <section id="description" class="mb-5">
            @include('help.product-detail._partials.tabs.description')
        </section>

        <section id="specifications" class="mb-5">
            @include('help.product-detail._partials.tabs.specifications')
        </section>

        <section id="videos" class="mb-5">
            @include('help.product-detail._partials.tabs.videos')
        </section>

        <section id="faq" class="mb-5">
            @include('help.product-detail._partials.tabs.faq')
        </section>

        <section id="comments" class="mb-5">
            @include('help.product-detail._partials.tabs.comments')
        </section>
    </div>
</div>
