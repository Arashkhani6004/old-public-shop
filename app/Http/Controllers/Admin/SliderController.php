...
class SliderController extends Controller
{
    ...
    {
        $query = Content::query();
        $query->wherein('content_type',[2,3,6,7,8]);
    ...
    {
        $mobile = Content::orderBy('id','DESC')->wherein('content_type',[9,10,11])
            ->paginate(100);
        $categorySort5 = Content::orderby('sort', 'ASC')->where('content_type',9)->get();

        $categorySort6 = Content::orderby('sort', 'ASC')->where('content_type',10)->get();
        $categorySort7 = Content::orderby('sort', 'ASC')->where('content_type',11)->get();
    ...
    public function postAddMobile(SliderRequest $request)
    {
        $input = $request->all();
