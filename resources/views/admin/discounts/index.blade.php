...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
		<form method="post" action="{{url('/adminstrator/discounts/delete')}}" style="float: left">
			{{ csrf_field() }}
			<div class="">
				...
				<div class="px-2 py-3">
					...
					<a href="{{url('adminstrator/discounts/add')}}" type="button" class="btn btn-space btn-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
