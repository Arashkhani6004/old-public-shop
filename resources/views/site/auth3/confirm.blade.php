		...
		<div class="bg-white rounded-custom px-sm-5 px-xs-2 pt-lg-0 pt-sm-4 pt-xs-4">
			<div class="row w-100 m-0">
				...
				<div class="col-xl-5 col-md-6 align-self-center p-1">
                    <form class="mb-0" method="post" action="{{URL::action('Panel\LoginController@postConfirm')}}"
							...
							<div class="row w-100 m-0">
								...
								<div class="col-sm-12 p-1">
									<div class="form-floating">
										<input type="password" name="confirm_code" class="form-control text-center" value="" id="number" placeholder="کدی که برای شما ارسال کرده ایم را وارد کنید">
...
{{--								</div>--}}
                    ...
                    <form class="mb-0" method="post" action="{{URL::action('Panel\LoginController@postReCon')}}"
                          enctype="multipart/form-data">
                        {{ csrf_field() }}
