                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    @foreach($category as $row)
                                        <tr class="@if($number/2 == 0) even @else odd  @endif pointer">
                                            ...
                                            <td class=" last">
                                                <a href="{{url('adminstrator/specification-type/edit/'.$row->id)}}" class="btn btn-default btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="ویرایش">ویرایش
                                                </a>
                                                <a href="{{url('adminstrator/specification-type/delete/'.$row->id)}}" class="btn btn-default btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="حذف">حذف
                                                </a>
