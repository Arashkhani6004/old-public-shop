...
{{--														</th>--}}
												...
												<tbody>
													...
													<tr role="row" class="odd">
                                                        ...
                                                        <td class="sorting_1"><img src="{{asset('assets/uploads/content/users/'.$row->avatar)}}" style="width: 70px; height: 70px; border-radius: 50%;" alt=""></td>
...
{{--                                                                    special--}}
                                                                    ...
                                                                    @else
                                                                        <span class='label label-info text-dark'>معمولی</span>
                                                                    @endif
                                                                    @if($row->special == 0)

                                                                        <a href="{{route('admin.user.special',['id'=>$row->id])}}" data-toggle="tooltip"
                                                                           class="btn btn-outline-success  btn-xs">ویژه کردن کاربر</a>
                                                                    @else
                                                                        <a href="{{route('admin.user.special',['id'=>$row->id])}}" data-toggle="tooltip"
                                                                           class="btn btn-info  btn-xs" ></i>معمولی کردن کابر</a>
                                                                    @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{URL::action('Admin\UserController@getAddress',$row->id)}}" type="button" class="btn btn-secondary text-white"> آدرس ها</a>
...
@foreach($data as $row2)
    <div class="modal fade" id="edit{{$row2->id}}" tabindex="-1" role="dialog" aria-labelledby="messageModalLabel"
         aria-hidden="true">
                ...
                <div class="modal-body p-3">
                    <div class="row w-100 m-0">
                        <div class="form-group">
                            <label class="col-lg-3 control-label">نام:</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" id="name" name="name" value="{{$row2->name}}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">نام خانوادگی:</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" id="family" name="family" value="{{$row2->family}}" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">ایمیل:</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="email" id="email" name="email" value="{{$row2->email}}" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">تلفن:</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" id="mobile" name="mobile" value="{{$row2->mobile}}" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">جنسیت :</label>
                            <div class="col-lg-9">
                                <select name="gender" id="gender" class="form-control" disabled>
                                    @foreach($gender as $key=>$item)
                                        <option value="{{$key}}" @if(isset($row2->gender) and $row2->gender==$key)
                                        selected
                                            @endif>{{$item}}</option>
                                    @endforeach
                                </select>
...
@foreach($data as $row3)
    <div class="modal fade" id="exampleModal1{{$row3->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{URL::action('Admin\UserController@postPassEdit',$row3->id)}}">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>رمز:</label>
                                    <input class="form-control" type="password" id="password" value="@if(isset($row3->password)){{$row3->password}}@endif" name="password"
                                           placeholder="رمز عبور">
                                </div>
                                <div class="col-md-12">
                                    <label>تکرار رمز:</label>
                                    <input class="form-control" type="password" value="@if(isset($row3->password)){{$row3->password}}@endif" id="repassword" name="repassword"
