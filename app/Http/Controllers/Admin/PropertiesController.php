...
class PropertiesController extends Controller
{
    ...
    {
        $questions = Properties::where('product_id', $id)->orderby('sort','ASC')->paginate(100);
    ...
    public function postEdit($id, Request $request)
    {
        ...
        return \redirect('/adminstrator/properties/' . $properties->product_id)->with('success', 'آیتم موردنظر با موفقیت ثبت شد.');
    }
    ...
    public function postDelete(Request $request)
    {
        ...
        if($orders){
            ...
            return Redirect::back()->with('error', 'رکوردی برای حذف پیدا نشد.');
        }
    }
