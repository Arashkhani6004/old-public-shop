...
@section('content')
        ...
        <div class="card">
                                    ...
                                    <form method="GET" action="{{ URL::current() }}" class="m-0">
                                        ...
                                        <div class="row w-100 m-0">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input autocomplete="off" class="form-control date" type="text"
                                                        id="start" name="start" placeholder="از تاریخ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input autocomplete="off" class="form-control date" type="text"
                                                        id="end" name="end" placeholder="تا تاریخ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input class="form-control" type="text" id="family"
                                                        name="family">
                                                </div>
                                            </div>
                                            <div class="form-group">
            ...
            <form method="post" action="{{ URL::action('Admin\UserController@postDelete') }}">
                ...
                <div class="py-3 px-2">
                    ...
                    <a href="{{ URL::action('Admin\UserController@getAdd') }}" type="button"
                                                    ...
                                                    <tbody>
                                                        @foreach ($data as $key => $row)
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td class="sorting_1">{{ $row->name . ' ' . $row->family }}
                                                                </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @if ($row->id !== 1)
                                                                        <a href="{{ URL::action('Admin\UserController@getEdit', [$row->id]) }}"
                                                                            data-toggle="tooltip"
                                                                            data-original-title="ویرایش اطلاعات"
                                                                            class="btn btn-space mb-0  btn-warning"><i
                                                                                class="fa fa-edit"></i> ویرایش </a>

                                                                        <a href="" type="button"
                                                                            class="btn btn-primary text-white"
                                                                            data-toggle="modal"
                                                                            data-target="#exampleModal1{{ $row->id }}">پسورد</a>
                                                                    @endif
    ...
    @foreach ($data as $row2)
        <div class="modal fade" id="exampleModal1{{ $row2->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" type="password" value="" id="repassword"
                                            name="repassword" placeholder="تکرار رمز عبور">
                                    </div>
                                </div>
                            </div>
