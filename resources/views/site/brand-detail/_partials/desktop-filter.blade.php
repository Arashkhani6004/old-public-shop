<div class="col-xl-3 col-lg-4 p-1 d-lg-block d-none">
    <div class="sidebar">
        {{-- brand img in desktop --}}
        <div class="brand mb-2">
            <img src="{{ $brand->brand_image }}" class="w-100 rounded-3" width="100%" alt="{!! @$brand->title !!}"
        ...
        <div class="filter">
            ...
            {{-- @include('site.brand-detail.components.filtered-item') --}}
            <div class="accordion accordion-flush mt-2" id="accordionFilter">
                    ...
                    <div id="filter-one" class="accordion-collapse collapse show" data-bs-parent="#accordionFilter">
                        <div class="accordion-body">
                            <div class="row w-100 mx-0 mt-0">
                                <div class="col-6 p-1">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input name="min" type="text" min="0" max="1000000"
                                            id="min_price" readonly oninput="validity.valid||(value='0');"
                                ...
                                <div class="col-6 p-1">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input name="max" type="text" min="0" max="1000000"
                                            id="max_price" readonly oninput="validity.valid||(value='1000000');"
                                            class="price-range-field fm-re shadow-none form-control form-control-sm border-0 text-center p-2 ">
                                        <small class="m-0 color-title">
                                            تومان
                                        </small>
                                ...
                                <button @click="filterBrands()"
                                    class="btn primary-btn rounded-3 py-2 btn-submit-filter btn-sm mt-3" type="submit">
                                    اعمال فیلتر قیمت
                                </button>
                            </div>
                        </div>
                ...
                @include('site.brand-detail.components.filters')
