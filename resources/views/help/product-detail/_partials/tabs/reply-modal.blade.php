        ...
        <div class="modal-content bg-transparent border-0">
            ...
            <div class="modal-body">
                <div class="comment-form ">
                    <form method="post" action="/test-reply" enctype="multipart/form-data" class="m-0">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="title" id="exampleFormControlInput1"
                                placeholder="موضوع" value="عنوان تستی">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label small mb-1 fm-li">نظر</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="content" rows="3">متن تستی نظر</textarea>
                        </div>
