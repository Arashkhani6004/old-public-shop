...
<div class="container-fluid  dashboard-content">
	...
	<br>
	<div class="card">
		<form method="post" action="{{url('/adminstrator/sloagen/delete')}}" style="float: left">
			{{ csrf_field() }}
			<div class="px-2 py-3">
				...
				<a href="{{URL::action('Admin\SloagenController@getAdd')}}" type="button" class="btn btn-space btn-primary">
                    	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
                                                        ...
                                                        <td class="sorting_1">
                                                            @foreach($sloagen->categories as $category)
