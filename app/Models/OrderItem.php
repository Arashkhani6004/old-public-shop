...
class OrderItem extends Model
{
    ...
    protected $fillable = [
        ...
        'product_specification_type_id','product_specification_value_id',
...
//    }
    ...
    {
        return $this->belongsTo('App\Models\ProductSpecification', 'product_specification_type_id', 'product_specification_type_id');
    }
