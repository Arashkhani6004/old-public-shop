...
<div class="container-fluid  dashboard-content">
	...
	<div class="row w-100 m-0">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0 d-flex align-items-center justify-content-between bg-white">
			...
			<a href="{{url('adminstrator/products/')}}" class="btn btn-default btn-info m-0 rounded-0" style="float: left" data-toggle="tooltip" data-placement="top" title="" data-original-title="بازگشت">
				بازگشت
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td class="sorting_1 text-center">
                                                            ...
                                                            @if($row->thumbnail == 0)
                                                                <a class="btn btn-success m-0 rounded-0 me-2" href="{{URL::action('Admin\ProductController@editThumbnail',$row->id)}}">نمایش به عنوان کاور</a>
                                                            @endif
														</td>
													</tr>
													@endforeach
