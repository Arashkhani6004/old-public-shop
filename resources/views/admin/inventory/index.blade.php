...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
		<form method="post" action="{{url('/adminstrator/inventory/delete')}}">
			{{ csrf_field() }}
			<div class="py-3 px-2">
				...
				<a href="{{url('adminstrator/inventory/add')}}" type="button" class="btn btn-space btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td>
															<a href="{{URL::action('Admin\InventoryController@getEdit',$row->id)}}"
																type="button"
