<div class="card rounded-lg border-0 p-3"  id="app34534567">
    @if($parent_id == null)
        <form method="post" action="{{URL::action('Admin\ProductSpecificationTypeController@postAddMain',$parent_id)}}" class="form-horizontal form-label-left">
            <div class="row">
                {{ csrf_field() }}
                <div class="col-lg-4 offset-3 p-2">
                    ...
                    <div class="form-group">
                        ...
                        <input value="1" name="view" type="checkbox">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12" style="text-align: center;">
                    <button type="button" @click="plusMe()" class="btn btn-default btn-success" style="font-size: 9px; margin-right: 42%; margin-bottom: -2%;">
                        اضافه کردن مقدار<span class="fa fa-plus"></span>
                    </button>
                </div>
    ...
    @else
        <form method="post" action="{{URL::action('Admin\ProductSpecificationTypeController@postAdd',$parent_id)}}" class="form-horizontal form-label-left">
            <div class="row">
                {{ csrf_field() }}
                <div class="col-lg-12" style="text-align: center;">
