        ...
        <div class="ecommerce-widget">
            ...
            <div class="row">
                ...
                @if (Auth::user()->hasPermission('article-cat'))
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                        <a href="{{ URL::action('Admin\ArticleController@getArticleCat') }}"
                            class="text-decoration-none">
                            <div class="card">
                                <div class="card-body d-flex">
                                    <div class="metric-value d-inline-block w-100">
                ...
                @if (Auth::user()->hasPermission('inventory-receipt'))
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                        <a href="{{ URL::action('Admin\InventoryController@getReceipt') }}"
                            class="text-decoration-none">
                            <div class="card">
                                <div class="card-body d-flex">
                                    <div class="metric-value d-inline-block w-100">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">لینک های راهنمای سایت</h5>
                                    <button type="" class="close btn btn-lg p-0" data-dismiss="modal"
                                        aria-label="Close">
                                    ...
                                    <div class="row w-100 m-0">
                                        <div class="col-6 p-1">
                                            <a href="{{ url('/help') }}" target="_blank"
                                                ...
                                                لینک راهنمای صفحه اول
                                                <span class="fw-bolder text-danger ms-3">کلیک کنید</span>
                                            </a>
                                        </div>
                                        <div class="col-6 p-1">
                                            <a href="{{ url('/help/cat/det') }}" target="_blank"
                                                class="text-dark text-decoration-none d-flex align-items-center">
                                                لینک راهنمای صفحه لیست محصولات
                                                <span class="fw-bolder text-danger ms-3">کلیک کنید</span>
                                            </a>
                                        </div>
                                        <div class="col-6 p-1">
                                            <a href="{{ url('/help/pro/det') }}" target="_blank"
                                                class="text-dark text-decoration-none d-flex align-items-center">
                                                لینک راهنمای صفحه جزئیات محصول
                                                <span class="fw-bolder text-danger ms-3">کلیک کنید</span>
                                            </a>
                                        </div>
                                        <div class="col-6 p-1">
                                            <a href="{{ url('/help/blogs') }}" target="_blank"
                                                class="text-dark text-decoration-none d-flex align-items-center">
                                                لینک راهنمای صفحه لیست مقالات
                                                <span class="fw-bolder text-danger ms-3">کلیک کنید</span>
                                            </a>
                                        </div>
                                        <div class="col-6 p-1">
                                            <a href="{{ url('/help/blogs/det') }}" target="_blank"
                                                class="text-dark text-decoration-none d-flex align-items-center">
                                                لینک راهنمای صفحه لیست دسته بندی مقالات
                                                <span class="fw-bolder text-danger ms-3">کلیک کنید</span>
                                            </a>
                                        </div>
                                        <div class="col-6 p-1">
                                            <a href="{{ url('/help/blog-detail') }}" target="_blank"
                                                class="text-dark text-decoration-none d-flex align-items-center">
                                                لینک راهنمای صفحه جزئیات مقاله
                                                <span class="fw-bolder text-danger ms-3">کلیک کنید</span>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <a href="https://mahamitim.com/shop/public/assets/help/help.mp4" target="_blank"
                        class="text-decoration-none">
                        <div class="card">
                            <div class="card-body d-flex">
                                <div class="metric-value d-inline-block w-100">
