...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
{{--		<form method="post" action="{{url('/adminstrator/article-cat/delete')}}">--}}
{{--			{{ csrf_field() }}--}}
			<div class="py-3 px-2">
...
{{--					حذف انتخاب شده ها--}}
{{--				</button>--}}
				<a href="{{url('adminstrator/article-cat/add')}}" type="button" class="btn btn-space btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
                                                        ...
                                                        <td class="sorting_1">            {{($article_cat->appends(Request::except('page'))->currentPage() - 1) *
                                          ($article_cat->appends(Request::except('page'))->perPage()) + $key+1}}</td>
